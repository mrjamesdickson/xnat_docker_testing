                ...
                {text:"Modify", handler:{fn:function () {
                    ...
                    xmodal.confirm({
                            ...
                            content: "" +
                                ...
                                "'s storage space.  " + (XNAT.app.rerunProjectAnonOnRename?"If a project level anonymization script is configured, it will result in the re-execution of project level anonymization (though reject statements will be ignored).":"") + " Are you sure you want to make this change?</p>",
                            okAction: function(){
                                if(showReason){
